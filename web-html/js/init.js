/*Lib builder - init.js: (components/classie.js,components/modernizr-custom.js,components/webfontloader.js,init.js)*/
/* web-html/_assets/js/components/classie.js */
/*!
 * classie v1.0.1
...
if ( 'classList' in document.documentElement ) {
  ...
  addClass = function( elem, c ) {
    console.log("elem.classList.add("+ c+")");
 ...
 * Build http://modernizr.com/download/#-canvas-es5array-flexbox-flexboxlegacy-flexboxtweener-flexwrap-history-inlinesvg-json-queryselector-addtest-atrule-domprefixes-fnbind-hasevent-mq-prefixed-prefixedcss-prefixes-testallprops-testprop-teststyles-dontmin
 *
 * Copyright (c)
 *  Faruk Ates
 *  Paul Irish
