...
check('http://'.$_SERVER["SERVER_NAME"].'/css/styles.css');
check('http://'.$_SERVER["SERVER_NAME"].'/js/init.js');
check('http://'.$_SERVER["SERVER_NAME"].'/css/fonts/Raleway-Light-webfont.woff');
function check($uri)
{
	// prepare cURL
	$ch = curl_init($uri);
